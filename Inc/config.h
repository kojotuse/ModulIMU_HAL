...
#define SPIx_CSN_PIN                            GPIO_PIN_1
#define SPIx_CSN_GPIO_PORT                      GPIOB
#define SPIx_CSN_GPIO_CLK_ENABLE()              __HAL_RCC_GPIOB_CLK_ENABLE()

#define SPIx_CE_PIN                             GPIO_PIN_8
#define SPIx_CE_GPIO_PORT                       GPIOB
#define SPIx_CE_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOB_CLK_ENABLE()

#define RADIO_IRQ_PIN                           GPIO_PIN_2
#define RADIO_IRQ_GPIO_PORT                     GPIOA
#define RADIO_IRQn                              EXTI2_3_IRQn
